        ...
        JSON1.request(url, function(result){ 
                ...
                if (result.MajorCode == '000') {
                    if (result.MinorCode == '1006'){
                        ...
                        var updateAsset = getStatusNewState({'asset':asset, 'changeState':{'name':'immob','state':result.Data.State}});
                        if (updateAsset) {
                            updateAssetList(updateAsset);  
                        }
...
function recharge(){
    ...
    mainView.router.load({
        ...
        context:{
            userCode: MinorToken,
            dealerNumber: '2',    // 2 - means M-Protekt
            button10: button10,
            button50: button50,
            button100: button100,
            buttonCur: buttonCur,
            other: 'MotoProtekt-app'
        },
...
function loadPageSupport(){
    ...
    var param = {
        ...
        'email':'',
        'phone':'',
        'service':'7', //means quikloc8.co in support page
    };
